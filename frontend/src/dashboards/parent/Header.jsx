                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div className="d-none d-md-block text-start">
                                    <p className="m-0 fw-semibold fs-6 lh-1 text-dark">{user?.firstName || user?.fullName || 'Parent User'}</p>
                                    <small className="text-muted" style={{ fontSize: '12px' }}>{user?.role || 'Parent'}</small>
                                </div>
                            </a>
