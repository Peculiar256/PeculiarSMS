      ...
      <body>
        <div class="container">
          ...
          <div class="summary">
            ...
            <div class="summary-item">
              <div class="number">${countByGender(teachers, 'MALE')}</div>
              <div class="label">Male Teachers</div>
            </div>
            <div class="summary-item">
              <div class="number">${countByGender(teachers, 'FEMALE')}</div>
              <div class="label">Female Teachers</div>
            </div>
            <div class="summary-item">
...
// Helper functions
const countByGender = (teachers, gender) => {
  return teachers.filter(t => t.gender === gender).length;
};

const getTopDepartment = (teachers) => {
